...
REGION_TEXTS: dict[int, str] = {
    0: "left anterior inferior region of the mandible",
    1: "left anterior superior region including the condylar process",
    2: "left posterior inferior region of the mandibular body",
    3: "left posterior superior region of the mandibular ramus",
    4: "midline anterior inferior region near the symphysis",
    5: "right anterior inferior region of the mandible",
    6: "right anterior superior region including the condylar process",
    7: "right posterior inferior region of the mandibular body",
    8: "right posterior superior region of the mandibular ramus",
}
